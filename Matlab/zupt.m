...
%% Zero-velocity detection for the whole dataset
iszv = zeros(1, N);
T = zeros(1, N-W+1);
for k = 1:N-W+1
...
% Accelerometer Bias Values (in m/s^2)
bias_a = [0; 0; 0];  

% Gyroscope Bias Values (in rad/s)
bias_w = [0; 0; 0];

% Initial roll, pitch, and yaw angles from accelerometer
...
% Measurement matrix (for zero-velocity update)
